    ...
    <>
      ...
      <div className="group/conversation-turn relative flex w-full min-w-0 flex-col agent-turn">
        <div className="flex-col gap-1 md:gap-3">
          ...
          <div className="mt-1 flex gap-3 empty:hidden ml-3">
                ...
                <span className="" data-state="closed">
                  ...
                  >
                    <div className="flex items-center pb-0">
                      ...
                      <span className="overflow-hidden text-clip whitespace-nowrap text-sm" style={{ opacity: "0", paddingLeft: "0px", width: "0px" }}>
                        4o
                      </span>
                      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24" className="icon-sm text-token-text-quaternary">
                        <path
                          fill="currentColor"
                          fillRule="evenodd"

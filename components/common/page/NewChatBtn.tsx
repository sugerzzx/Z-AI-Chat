...
const NewChatBtn: FC<NewChatBtnProps> = ({ className }) => {
  return (
    <BootstrapTooltip title="New chat">
      <IconButton aria-label="delete" size="large" className={cn("h-10 rounded-lg px-2 text-token-text-secondary focus-visible:outline-0", className)}>
